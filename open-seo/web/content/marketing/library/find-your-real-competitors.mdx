...
To pull one of those domains apart straight away, the [free SEO competitor analysis tool](/competitor-analysis) lists its top keywords and pages in one run.
